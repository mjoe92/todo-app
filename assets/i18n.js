...
const TRANSLATIONS = {
    en: {
        ...
        ignoreTask: 'Ignore task',
        unignoreTask: 'Unignore task',
        ignore: 'Ignore',
        unignore: 'Unignore',
        ...
        addedOn: 'Added',
        emptyAllLabel: 'No tasks yet',
        emptyActiveLabel: 'No active tasks',
        emptyDoneLabel: 'No completed tasks',
        emptyIgnoredLabel: 'No ignored tasks',
        emptyAllDesc: 'Tap "New task" to get started.',
        emptyActiveDesc: 'Everything is done!',
    ...
    hu: {
        ...
        filterActive: 'Aktív',
        filterDone: 'Kész',
        filterIgnored: 'Kihagyott',
        filterAll: 'Mind',
        swipeHint: '← Balra húzva törlés · Jobbra húzva kihagyás →',
        modalTitleNew: 'Új feladat',
        modalTitleEdit: 'Feladat szerkesztése',
        modalLabel: 'Feladat neve',
        modalPlaceholder: 'Mit kell elvégezni?',
        modalCancel: 'Mégsem',
        modalAdd: 'Hozzáadás',
        modalSave: 'Mentés',
        badgeDone: 'Kész',
        badgeIgnored: 'Kihagyott',
        ignoreTask: 'Feladat kihagyása',
        unignoreTask: 'Kihagyás visszavonása',
        ignore: 'Kihagyás',
        unignore: 'Visszavonás',
        deleteTask: 'Feladat törlése',
        delete: 'Törlés',
        markDone: 'Feladat megjelölése készként',
        addedOn: 'Hozzáadva',
        emptyAllLabel: 'Még nincsenek feladatok',
        emptyActiveLabel: 'Nincs aktív feladat',
        emptyDoneLabel: 'Nincs befejezett feladat',
        emptyIgnoredLabel: 'Nincs kihagyott feladat',
        emptyAllDesc: 'Nyomd meg az „Új feladat” gombot a kezdéshez.',
        emptyActiveDesc: 'Minden feladat elkészült!',
    ...
    es: {
        ...
        filterDone: 'Hechas',
        filterIgnored: 'Ignoradas',
        filterAll: 'Todas',
        swipeHint: '← Deslizar izquierda para eliminar · derecha para ignorar →',
        modalTitleNew: 'Nueva tarea',
        modalTitleEdit: 'Editar tarea',
        modalLabel: 'Título de la tarea',
        modalPlaceholder: '¿Qué hay que hacer?',
        modalCancel: 'Cancelar',
        modalAdd: 'Añadir',
        modalSave: 'Guardar',
        badgeDone: 'Hecha',
        badgeIgnored: 'Ignorada',
        ignoreTask: 'Ignorar tarea',
        unignoreTask: 'Dejar de ignorar',
        ignore: 'Ignorar',
        unignore: 'Restaurar',
        deleteTask: 'Eliminar tarea',
        delete: 'Eliminar',
        markDone: 'Marcar tarea como hecha',
        addedOn: 'Añadido',
        emptyAllLabel: 'Aún no hay tareas',
        emptyActiveLabel: 'No hay tareas activas',
        emptyDoneLabel: 'No hay tareas completadas',
        emptyIgnoredLabel: 'No hay tareas ignoradas',
        emptyAllDesc: 'Pulsa «Nueva tarea» para empezar.',
        emptyActiveDesc: '¡Todo está hecho!',
...
function setLang(lang) {
    ...
    langOffset = Math.min(
        Math.max(0, Math.floor(idx / PAGE_SIZE) * PAGE_SIZE),
        Math.max(0, SUPPORTED_LANGS.length - PAGE_SIZE)
    );
